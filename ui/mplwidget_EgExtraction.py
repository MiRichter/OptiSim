...
class MplWidgetEgExtraction(QtWidgets.QWidget):
    ...
    def showCurves(self, xAxes, curves, xLabel, yLabel, minX, maxX):
        # fill data table
        ...
        self.ax.axvline(x=minX)
        self.ax.axvline(x=maxX)
    ...
    def plot(self, x, y, curvetitle):
        ...
        if curvetitle == 'fit':
            ...
            axis.plot(x, y,  'o', picker=5, label=curvetitle)
